...
import 'package:dating_app/Serializers/Chopper/UsersRespSerializer.dart';
import 'package:built_collection/built_collection.dart';

class UsersRespConverter extends JsonConverter {
  @override
  Request convertRequest(Request request) {
    return super.convertRequest(
      request.replace(
        body: usersResp_serializers.serializeWith(
          usersResp_serializers.serializerForType(request.body.runtimeType),
          request.body,
        ),
      ),
    );
  ...
  SingleItemType _deserialize<SingleItemType>(
    ...
    return usersResp_serializers.deserializeWith(
      usersResp_serializers.serializerForType(SingleItemType),
      value,
    );
  }
}
