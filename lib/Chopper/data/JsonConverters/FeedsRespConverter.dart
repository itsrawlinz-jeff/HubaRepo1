...
import 'package:dating_app/Serializers/Chopper/FeedsRespSerializer.dart';
import 'package:built_collection/built_collection.dart';

class FeedsRespConverter extends JsonConverter {
  @override
  Request convertRequest(Request request) {
    return super.convertRequest(
      request.replace(
        body: feedsResp_serializers.serializeWith(
          feedsResp_serializers.serializerForType(request.body.runtimeType),
          request.body,
        ),
      ),
    );
  ...
  SingleItemType _deserialize<SingleItemType>(
    ...
    return feedsResp_serializers.deserializeWith(
      feedsResp_serializers.serializerForType(SingleItemType),
      value,
    );
  }
}
