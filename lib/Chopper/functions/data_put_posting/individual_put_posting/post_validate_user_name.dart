...
Future<bool> post_validate_user_name(
  ...
  userNameValidationReqJModel.validation_text = username;

  Response response = await Provider.of<PostApiService>(context)
      .validatecustomuser_by_user_name(userNameValidationReqJModel);
