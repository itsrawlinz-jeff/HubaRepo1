...
import 'package:dating_app/UI/Presentation/OnBoardingOptions/OnBoardingEthnicityOption.dart';
...
class Which_Ethnicity_Desc_You_OB_Page extends StatefulWidget {
  ...
  Which_Ethnicity_Desc_You_OB_Page(
      {Key key,
...
class _OB_Page6State extends State<Which_Ethnicity_Desc_You_OB_Page>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<Which_Ethnicity_Desc_You_OB_Page>,
        AfterLayoutMixin<Which_Ethnicity_Desc_You_OB_Page> {
  ...
  String TAG = 'Which_Ethnicity_Desc_You_OB_Page:';
  ...
  initUI() async {
    ...
    ethnicityDao.getActiveEthnicitieList().then(
        (List<Ethnicitie> ethnicitieList) {
      if (ethnicitieList != null) {
        for (Ethnicitie ethnicitie in ethnicitieList) {
          optionsDynamic.add(new OnBoardingEthnicityOption(
            isSelected: ethnicitie.id == widget.onboarding.ethnicity,
            isSelectable: true,
                  ...
                  builder: (BuildContext context) => Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        SizedBox(height: 60),
                        CustomTitleView(
                          titleTxt: 'Which ethnicities best describe you?',
                          subTxt: '',
