...
import 'package:dating_app/UI/Presentation/OnBoardingOptions/OnBoardingDrinkStatusOption.dart';
...
class Do_You_Wnt_Date_Drink_OB_Page extends StatefulWidget {
...
class _OB_Page6State extends State<Do_You_Wnt_Date_Drink_OB_Page>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<Do_You_Wnt_Date_Drink_OB_Page>,
        AfterLayoutMixin<Do_You_Wnt_Date_Drink_OB_Page> {
  ...
  String TAG = 'Do_You_Wnt_Date_Drink_OB_Page:';
  ...
  initUI() async {
    ...
    drinkstatusDao.getActiveDrinkstatuseList().then(
        (List<Drinkstatuse> drinkstatuseList) {
      if (drinkstatuseList != null) {
        for (Drinkstatuse drinkstatuse in drinkstatuseList) {
          optionsDynamic.add(new OnBoardingDrinkStatusOption(
            isSelected: drinkstatuse.id == widget.onboarding.want_date_to_drink,
            isSelectable: true,
        ...
        print('drinkstatuseList IS NULL');
      }
    }, onError: (error) {
      print('error== ${error}');
    });
              ...
              builder: (BuildContext context) => Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 60),
                    CustomTitleView(
                      titleTxt: 'Do you want your date to take alcohol?',
                      subTxt: '',
