...
import 'package:dating_app/UI/Presentation/OnBoardingOptions/OnBoardingSearchingForOption.dart';
...
class Searching_For_OB_Page extends StatefulWidget {
...
class _OB_Page6State extends State<Searching_For_OB_Page>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<Searching_For_OB_Page>,
        AfterLayoutMixin<Searching_For_OB_Page> {
  ...
  String TAG = 'Searching_For_OB_Page:';
  ...
  initUI() async {
    ...
    genderDao.getMaleFemaleGenderOnlyList().then((List<Gender> genderList) {
      if (genderList != null) {
        for (Gender gender in genderList) {
          optionsDynamic.add(new OnBoardingSearchingForOption(
            isSelected: gender.id == widget.onboarding.searchingfor,
            isSelectable: true,
