...
import 'package:dating_app/UI/Presentation/OnBoardingOptions/OnBoardingRelStatusOption.dart';
...
class Rel_Status_OB_Page extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _Rel_Status_OB_PageState();
  }
}
...
class _Rel_Status_OB_PageState extends State<Rel_Status_OB_Page>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<Rel_Status_OB_Page>,
        AfterLayoutMixin<Rel_Status_OB_Page> {
  ...
  initUI() async {
    ...
    relationshipstatusDao.getActiveRelationshipstatuseList().then(
        (List<Relationshipstatuse> relationshipstatuseList) {
      if (relationshipstatuseList != null) {
        for (Relationshipstatuse relationshipstatuse
            in relationshipstatuseList) {
          optionsDynamic.add(new OnBoardingRelStatusOption(
            isSelected:
                relationshipstatuse.id == widget.onboarding.relationshipstatus,
            isSelectable: true,
            onboarding: widget.onboarding,
            onboardingDao: onboardingDao,
            relationshipstatuse: relationshipstatuse,
                  ...
                  builder: (BuildContext context) => Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        SizedBox(height: 60),
                        CustomTitleView(
                          titleTxt: 'What is your relationship status?',
                          subTxt: '',
