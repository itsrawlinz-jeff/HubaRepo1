...
import 'package:dating_app/UI/Presentation/OnBoardingOptions/OnBoardingReligionOption.dart';
...
class Your_Religion_OB_Page extends StatefulWidget {
...
class _OB_Page6State extends State<Your_Religion_OB_Page>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<Your_Religion_OB_Page>,
        AfterLayoutMixin<Your_Religion_OB_Page> {
  ...
  OnBoardingClickableItemBLoC onBoardingClickableItemBLoC =
      OnBoardingClickableItemBLoC();
  String TAG = 'Your_Religion_OB_Page:';
  ...
  initUI() async {
    ...
    religionDao.getActiveReligionList().then((List<Religion> religionList) {
      if (religionList != null) {
        for (Religion religion in religionList) {
          optionsDynamic.add(new OnBoardingReligionOption(
            isSelected: religion.id == widget.onboarding.religion,
            isSelectable: true,
              ...
              builder: (BuildContext context) => Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 60),
                    CustomTitleView(
                      titleTxt:  'What is your religion?',
                      subTxt: '',
