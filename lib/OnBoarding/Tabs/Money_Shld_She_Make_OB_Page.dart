...
import 'package:dating_app/UI/Presentation/OnBoardingOptions/OnBoardingMoneySheShouldMakeOption.dart';
...
class Money_Shld_She_Make_OB_Page extends StatefulWidget {
...
class _OB_Page6State extends State<Money_Shld_She_Make_OB_Page>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<Money_Shld_She_Make_OB_Page>,
        AfterLayoutMixin<Money_Shld_She_Make_OB_Page> {
  ...
  String TAG = 'Money_Shld_She_Make_OB_Page:';
  ...
  /*initUIold() async {
    ...
    incomerangeDao = database.incomerangeDao;
    onboardingmoneyshemakeDao = database.onboardingmoneyshemakeDao;

    incomerangeDao.getActiveIncomerangeList().then(
        (List<Incomerange> incomerangeList) {
      if (incomerangeList != null) {
        for (Incomerange incomerange in incomerangeList) {
          optionsDynamic.add(new FutureBuilder(
              ...
              builder: (context, snapshot) {
                if (!snapshot.hasData) {
                  ...
                  return new OnBoardingMoneySheShouldMakeOption(
                    isSelected:
                        incomerange.id == widget.onboarding.often_you_drink,
                    isSelectable: true,
  ...
  initUI() async {
    ...
    incomerangeDao.getActiveIncomerangeList().then(
        (List<Incomerange> incomerangeList) async {
      if (incomerangeList != null) {
        for (Incomerange incomerange in incomerangeList) {
          optionsDynamic.add(new FutureBuilder(
              future: onboardingmoneyshemakeDao.isIncomeRangeInOnBoardingById(
                  incomerange.id, widget.onboarding.id),
              builder: (context, snapshot) {
                if (!snapshot.hasData) {
                  return invisibleWidget();
                } else {
              ...
              builder: (BuildContext context) => Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 60),
                    CustomTitleView(
                      titleTxt: 'How much money should she make?',
                      subTxt: '',
                    ...
                    /*Transform(
                      ...
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            'How much money should she make?',
