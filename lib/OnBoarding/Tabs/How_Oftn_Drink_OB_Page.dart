...
import 'package:dating_app/UI/Presentation/OnBoardingOptions/OnBoardingOftenDrinkOption.dart';
...
class How_Oftn_Drink_OB_Page extends StatefulWidget {
...
class _OB_Page6State extends State<How_Oftn_Drink_OB_Page>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<How_Oftn_Drink_OB_Page>,
        AfterLayoutMixin<How_Oftn_Drink_OB_Page> {
  ...
  OnBoardingClickableItemBLoC onBoardingClickableItemBLoC =
      OnBoardingClickableItemBLoC();
  String TAG = 'How_Oftn_Drink_OB_Page:';
    ...
    drinkstatusDao.getActiveDrinkstatuseList().then(
      ...
      if (drinkstatuseList != null) {
        for (Drinkstatuse drinkstatuse in drinkstatuseList) {
          optionsDynamic.add(new OnBoardingOftenDrinkOption(
            isSelected: drinkstatuse.id == widget.onboarding.often_you_drink,
            isSelectable: true,
                  ...
                  builder: (BuildContext context) => Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        SizedBox(height: 60),
                        CustomTitleView(
                          titleTxt: 'How often do you drink?',
                          subTxt: '',
