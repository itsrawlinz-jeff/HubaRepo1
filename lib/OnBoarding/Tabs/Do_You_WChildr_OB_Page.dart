...
import 'package:dating_app/UI/Presentation/OnBoardingOptions/OnBoardingWantChildrenOption.dart';
...
class Do_You_WChildr_OB_Page extends StatefulWidget {
...
class _OB_Page6State extends State<Do_You_WChildr_OB_Page>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<Do_You_WChildr_OB_Page>,
        AfterLayoutMixin<Do_You_WChildr_OB_Page> {
  ...
  OnBoardingClickableItemBLoC onBoardingClickableItemBLoC =
      OnBoardingClickableItemBLoC();
  String TAG = 'Do_You_WChildr_OB_Page:';
  ...
  initUI() async {
    ...
    wantchildrenstatusDao.getActiveWantchildrenstatuseList().then(
        (List<Wantchildrenstatuse> wantchildrenstatuseList) {
      if (wantchildrenstatuseList != null) {
        for (Wantchildrenstatuse wantchildrenstatuse
            in wantchildrenstatuseList) {
          optionsDynamic.add(new OnBoardingWantChildrenOption(
            isSelected:
                wantchildrenstatuse.id == widget.onboarding.want_children,
            isSelectable: true,
            onboarding: widget.onboarding,
            onboardingDao: onboardingDao,
            wantchildrenstatuse: wantchildrenstatuse,
        ...
        print('wantchildrenstatuseList IS NULL');
      }
    }, onError: (error) {
      print('error== ${error}');
    });
