...
import 'package:dating_app/UI/Presentation/OnBoardingOptions/OnBoardingEducationLevelOption.dart';
...
class Edu_Level_OB_Page extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _Edu_Level_OB_PageState();
  }
}
...
class _Edu_Level_OB_PageState extends State<Edu_Level_OB_Page>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<Edu_Level_OB_Page>,
        AfterLayoutMixin<Edu_Level_OB_Page> {
    ...
    educationLevelDao.getActiveEducationlevelList().then(
      ...
      if (educationlevelList != null) {
        for (Educationlevel educationlevel in educationlevelList) {
          optionsDynamic.add(new OnBoardingEducationLevelOption(
            isSelected: educationlevel.id == widget.onboarding.education_level,
            isSelectable: true,
                  ...
                  builder: (BuildContext context) => Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        SizedBox(height: 60),
                        CustomTitleView(
                          titleTxt: 'What is your education level?',
                          subTxt: '',
