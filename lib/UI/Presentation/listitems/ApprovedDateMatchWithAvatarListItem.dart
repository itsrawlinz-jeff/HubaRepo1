...
class ApprovedDateMatchWithAvatarListItem extends StatefulWidget {
  AnimationController animationController;
  Animation animation;
  IntindexCallback functionCallback;
  DateMatchRespJModel dateMatchRespJModel;

  ApprovedDateMatchWithAvatarListItem({
    Key key,
  ...
  @override
  _ApprovedDateMatchWithAvatarListItemState createState() => _ApprovedDateMatchWithAvatarListItemState();
}

class _ApprovedDateMatchWithAvatarListItemState extends State<ApprovedDateMatchWithAvatarListItem>
