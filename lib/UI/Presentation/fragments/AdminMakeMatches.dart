...
class AdminMakeMatches extends StatefulWidget {
  @override
  _AdminMakeMatchesState createState() => _AdminMakeMatchesState();
}

class _AdminMakeMatchesState extends State<AdminMakeMatches>
    with TickerProviderStateMixin, AfterLayoutMixin<AdminMakeMatches> {
              ...
              child: new Material(
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    dateMatchRespJModel.isuserrequested = false;
  ...
  Future<bool> onRefresh_fetchErpTickets_OnlineFetch(
    ...
    current_DateMatchListRespJModel = await fetch_datematches_online_limit(
      context,
  ...
  onSearchParamChanged(BuildContext context) async {
    ...
    if (isStringValid(searchParam)) {
      ...
      current_DateMatchListRespJModel =
          await fetch_datematches_online_limit_by_searchparam(
        context,
        DatingAppStaticParams.default_Query_Limit,
        searchParam,
      );
      ...
      if (current_DateMatchListRespJModel != null) {
        ...
        current_DateMatchListRespJModel = await fetch_datematches_online_limit(
            context, DatingAppStaticParams.default_Query_Limit);
        replace_FromFetched();
      }
    }
  }
  ...
  void function_AddMatch_Clicked(DateMatchRespJModel dateMatchRespJModel) {
    ...
    navigationData.selectedWidget = AdminCreateEditMatch(
      dateMatchReqJModel:
